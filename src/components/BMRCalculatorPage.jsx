            ...
            <div className="max-w-3xl mx-auto">
                <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-50 dark:border-gray-700">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white">BMR Calculator</h2>
                    </div>
                    ...
                    {bmrResult && (
                        <div id="bmr-result" className="mt-8 p-8 bg-linear-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-2xl border-2 border-amber-200 dark:border-amber-800 animate-scale-in">
