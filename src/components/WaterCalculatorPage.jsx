...
const WaterCalculatorPage = ({ waterWeight, setWaterWeight, waterActivity, setWaterActivity, calculateWater, waterResult, waterError, setCurrentPage, t }) => {
    ...
    const content = calculatorContent['water']?.['en'];
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="max-w-3xl mx-auto">
                    <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-50 dark:border-gray-700">
                        ...
                        {waterResult && (
                            <div id="water-result" className="mt-8 animate-scale-in space-y-6">
                                <div className="p-8 bg-linear-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-2xl border-2 border-emerald-200 dark:border-emerald-800">
                                    ...
                                    <div className="flex items-center justify-center gap-4">
                                        <Droplet className="w-12 h-12 text-emerald-500" fill="currentColor" />
                                        <p className="text-5xl font-black text-emerald-600 dark:text-emerald-400">{waterResult} {t.unit_liter}</p>
                                    </div>
                                </div>
                    ...
                    <div className="flex justify-center mt-8">
                        <button
                            ...
                            className="px-8 py-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all border border-gray-100 dark:border-gray-700"
                        >
                            {t.back_to_home}
                        </button>
                    </div>
