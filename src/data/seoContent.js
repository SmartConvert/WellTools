...
export const calculatorContent = {
    ...
    calories: {
        en: {
            ...
            seo_how_steps: [
                ...
                'View your personalized daily calorie recommendations'
            ],

            seo_tips_title: 'Calorie Management Tips',
            seo_tips: [
                '🎯 **Set Realistic Goals**: Aim for 500-750 calorie deficit for gradual, sustainable weight loss.',
                '🥗 **Quality Matters**: Focus on nutrient-dense foods rather than empty calories.',
                '📝 **Track Your Intake**: Use food journals or apps to monitor daily consumption.',
                '💪 **Adjust for Exercise**: Account for calories burned during workouts.'
            ],

            seo_faqs: [
                {
                    question: 'How many calories should I eat to lose weight?',
                    answer: 'For healthy weight loss, create a deficit of 500-750 calories per day from your maintenance level, aiming for 0.5-1kg weight loss per week.'
                },
                {
                    question: 'Does muscle mass affect calorie needs?',
                    answer: 'Yes! Muscle tissue burns more calories at rest than fat. People with higher muscle mass have higher metabolic rates and calorie needs.'
                }
            ]
        },
        ar: {
    ...
    water: {
        en: {
            ...
            seo_why_content: 'A generic "8 glasses a day" doesn\'t work for everyone. Your weight, climate, and activity level determine your specific needs. Dehydration can lead to fatigue, headaches, and impaired cognitive function.',
            seo_how_title: 'How to Use',
            seo_how_steps: ['Enter your weight', 'Select your daily activity level', 'Get your personalized hydration goal'],
            seo_tips_title: 'Hydration Tips',
            seo_tips: ['Drink before you feel thirsty', 'Use a reusable bottle to track progress', 'Eat water-rich fruits like melon and cucumber'],
            seo_faqs: [
                { question: 'Does coffee count toward hydration?', answer: 'Yes, but water is always the best choice for pure hydration.' },
                { question: 'What are signs of dehydration?', answer: 'Dark urine, dry mouth, and dizziness are common indicators.' }
            ]
        },
        ar: {
    ...
    'ideal-weight': {
        en: {
            ...
            seo_why_content: 'Having a target helps in setting realistic goals for lifestyle changes and clinical assessments.',
            seo_how_title: 'How to Use',
            seo_how_steps: ['Enter height', 'Select gender', 'Calculate range'],
            seo_tips_title: 'Healthy Weight Tips',
            seo_tips: ['Focus on body composition, not just scale weight', 'Build sustainable habits'],
            seo_faqs: []
        },
        ar: {
    ...
    sleep: {
        en: {
            ...
            seo_why_content: 'Quality sleep improves memory, mood, and immune function.',
            seo_how_title: 'How it Works',
            seo_how_steps: ['Enter wake up time', 'See suggested sleep times based on 90-minute cycles'],
            seo_tips_title: 'Sleep Hygiene Tips',
            seo_tips: ['Keep your bedroom cool and dark', 'Avoid screens 1 hour before bed'],
            seo_faqs: []
        },
        ar: {
    ...
    'body-fat': {
        en: {
            ...
            seo_why_content: 'Tracking body fat helps in monitoring muscle gain or fat loss progress accurately.',
            seo_how_title: 'How to Measure',
            seo_how_steps: ['Enter neck, waist, and hip measurements', 'Fill in height and weight'],
            seo_tips_title: 'Progress Tips',
            seo_tips: ['Measure in the morning on an empty stomach', 'Use consistent technique'],
            seo_faqs: []
        },
        ar: {
            hero_title: 'حاسبة نسبة الدهون',
            hero_subtitle: 'قدر نسبة الدهون في جسمك وفئة لياقتك البدنية',
            hero_emoji: '🍊',
            hero_color: 'from-orange-400 to-orange-600',
            seo_what_title: 'فهم دهون الجسم',
            seo_what_content: 'نسبة الدهون في الجسم هي إجمالي كتلة الدهون مقسومة على إجمالي كتلة الجسم. هي مؤشر أفضل للياقة البدنية من الوزن وحده.',
            seo_why_title: 'لماذا نقيس؟',
            seo_why_content: 'تتبع دهون الجسم يساعد في مراقبة تقدم اكتساب العضلات أو فقدان الدهون بدقة.',
            seo_how_title: 'كيفية القياس',
            seo_how_steps: ['أدخل قياسات الرقبة والخصر والورك', 'أدخل الطول والوزن'],
            seo_tips_title: 'نصائح للتقدم',
            seo_tips: ['قم بالقياس في الصباح على معدة فارغة', 'استخدم تقنية قياس ثابتة'],
            seo_faqs: []
        }
    }
};
